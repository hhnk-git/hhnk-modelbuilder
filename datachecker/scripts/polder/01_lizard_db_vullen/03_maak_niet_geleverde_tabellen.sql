--Script maakt tabellen in damo_ruw aan als ze niet bestaan. Dit omdat de datachecker anders crasht als er een tabel niet geleverd wordt (bijvoorbeeld geen aquaducten aangeleverd)
--DAMO schematisatie van 2018-03-21
