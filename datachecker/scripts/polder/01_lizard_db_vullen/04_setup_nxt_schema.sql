/* SCRIPT AANMAKEN EN UITBREIDEN LIZARD DATABASE */
/* SCRIPT AANMAKEN EN UITBREIDEN LIZARD DATABASE */
-- aanmaken tabellen relevant voor 3Di poldermodellen
-- aangemaakt exclusief rechten en/of indices
-- aangemaakt in schema 'nxt' ipv hydra_core prefix
-- aangemaakt exclusief constraints
