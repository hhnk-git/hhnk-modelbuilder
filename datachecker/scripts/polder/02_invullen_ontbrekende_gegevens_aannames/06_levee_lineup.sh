...
python3 raster-tools/line_up.py /code/data/fixed_data/DEM/DEM_AHN5/ahn5_dtm_filled_panden5cm.vrt /code/data/line-up/levee_split.shp /code/data/line-up/levee_height.shp -o -d 6 -w 2 -a 75 -l line -f lineupid -e 'height'
