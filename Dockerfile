...
FROM ubuntu:18.04
RUN apt-get update && apt-get install build-essential python3.8 python3-pip python3-dev python3-setuptools python3-gdal postgresql-client libpq-dev git software-properties-common -y --no-install-recommends
...
RUN pip3 install pip==10.0.1 pipenv==2018.5.18
COPY . .
