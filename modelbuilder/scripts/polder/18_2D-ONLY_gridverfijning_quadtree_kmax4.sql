...
IF EXISTS newid;
    ...
    set    on_off_loop1 = 1
    from
           deelgebied.grid_refinement b
    where
           st_intersects(a.geom,b.geom)
           and b.refinement_level=1
    ;
    ...
    IF EXISTS id;
        ...
        where
               on_off_loop1   =1
               or on_off_loop2=1
        ; --or on_off_loop3=1 or on_off_loop4=1 or on_off_loop4=1;
