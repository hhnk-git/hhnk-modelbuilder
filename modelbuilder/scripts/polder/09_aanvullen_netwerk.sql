...
WHERE
       ...
       OR connection_node_start_id IS NULL
;
...
SELECT *
FROM
       deelgebied.tmp_sel_pumpstation
WHERE
       connection_node_end_id      IS NULL
       OR connection_node_start_id IS NULL
;

-- TODO: renier: "als ik het goed begrijp gooien we nu een multipart duiker helemaal weg. Wellicht singleparts van maken en dan 1 overhouden??"
